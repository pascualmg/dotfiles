# =============================================================================
# MODULES/BASE/VIRTUALIZATION.NIX - Docker + libvirt para TODAS las maquinas
# =============================================================================
# Configuracion completa de virtualizacion:
#   - Docker: Contenedores para desarrollo
#   - libvirt/QEMU: Maquinas virtuales completas
#   - SPICE: Mejor integracion VM
#   - IOMMU: Soporte para passthrough (si hardware lo permite)
#
# Caracteristicas:
#   - Auto-prune semanal de Docker
#   - Bridge networking para VMs
#   - UEFI boot para VMs modernas
#
# Grupos de usuario requeridos (ya en users.nix):
...

{
  ...
  # Habilitado en todas las maquinas - no afecta si CPU no soporta
  boot = {
    kernelParams = [
      "intel_iommu=on"
      "amd_iommu=on"
