...
| 2 | Limpiar puertos aurin | PENDING | Eliminar duplicados, solo dejar específicos |
| 3 | Limpiar puertos vespino | PENDING | Eliminar duplicados, solo dejar específicos |
| 4 | Crear =modules/services/syncthing.nix= | PENDING | Config casi idéntica en aurin/vespino |
| 5 | Eliminar open-webui deshabilitado | PENDING | Código muerto (enable=false) en ambos hosts |
...
*** Tarea 5: Eliminar open-webui - PENDIENTE

*Motivo:* Código muerto. =open-webui.enable = false= en aurin y vespino.
Si está deshabilitado, no debería estar en producción.
