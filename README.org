...
| *Wayland compositors* | ✅ Hyprland, niri, GNOME Wayland (greetd) |
...
|---------+----------+-----+-----------------|
| aurin   | Dual Xeon E5-2699v3, RTX 5080, 128GB | Produccion, desarrollo | greetd |
| macbook | MacBook Pro 2016, Intel, HiDPI | Laptop, movilidad | greetd |
| vespino | AMD CPU, RTX 2060 | Testing, Minecraft, NFS | greetd |
...
** Display Managers: La saga GDM -> LightDM -> greetd (RESUELTO 2026-01-24)
...
*Era 3: greetd + tuigreet (2026-01-24)*
Solucion definitiva: greetd con tuigreet (TUI greeter).
...
*** Por que greetd + tuigreet

| Caracteristica | GDM | LightDM | greetd |
|----------------+-----+---------+--------|
| X11 sessions | Si (roto NVIDIA) | Si | Si |
| Wayland sessions | Si | NO | Si |
| Dependencias | Pesadas (GNOME) | Medias | Minimas |
| TUI login | No | No | Si (tuigreet) |
| NVIDIA compatible | Problematico | Si | Si |

*** Controles de tuigreet
...
Estas variables se aplican DESPUES del login (sesion), no en greetd (pre-login)
...
- [X] *WAYLAND RESUELTO* - greetd + tuigreet soporta X11 y Wayland (2026-01-24)
