...
** Display Managers: GDM vs LightDM - RESUELTO (2026-01-19)

*Estado:* RESUELTO - LightDM para todas las maquinas
...
|---------+----+-------+-------+--------|
| aurin | LightDM | XMonad + GNOME disponible | home-manager | OK |
| vespino | LightDM | XMonad + GNOME disponible | home-manager | OK |
| macbook | LightDM | XMonad + GNOME disponible | home-manager | OK |
