...
1. [X] *xmobar* - ✅ COMPLETADO (2025-01-04)
...
2. [ ] *xmonad* - Similar a xmobar, puede parametrizarse
3. [ ] *alacritty* - Archivo estático, fácil de migrar con =home.file=
4. [ ] *picom* - Archivo estático
5. [ ] *fish* - Usar =programs.fish= nativo de home-manager
6. [ ] Eliminar bloque =activation.linkDotfiles= de passh.nix (quitar configs migradas)
7. [ ] Eliminar carpetas stow vacías
