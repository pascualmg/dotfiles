...
El chip T1 (Touch Bar + Touch ID) está en "Recovery Mode" permanente.
...
- Los drivers Linux (apple-ibridge, tiny-dfr) requieren el T1 en modo normal
...
*Workaround:* =caps:escape= en xkb.options para tener Escape en Caps Lock
