...
#+BEGIN_QUOTE
"No cambies de caballo - lleva tu montura"
— Filosofía HHKB (Happy Hacking Keyboard)
#+END_QUOTE

** El Problema que Todos Hemos Vivido

Imagina este escenario (que has vivido 100 veces):

1. *Reinstalar Windows/Mac/Linux*
   - "Joder, ¿dónde estaba esa config de VSCode?"
   - "¿Cómo se llamaba ese plugin de Vim?"
   - "Ah coño, ¿cómo configuré el Docker Compose?"
   - *3 horas después:* "Creo que ya está... pero falta algo"

2. *Nuevo portátil del trabajo*
   - Teams, Slack, Docker, IntelliJ, Postman, DBeaver...
   - "¿En serio tengo que configurar TODO otra vez?"
   - *2 días perdidos* configurando herramientas

3. *Tu máquina de casa + portátil + servidor*
   - Cada una configurada diferente
   - Cambias algo en una → tienes que recordar cambiarlo en las otras
   - *Caos total* - nunca sabes qué funciona en cuál
