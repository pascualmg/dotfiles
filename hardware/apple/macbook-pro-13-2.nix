...
in
{
  ...
  services.xserver = {
    ...
    # Display setup para XMonad (HiDPI Retina)
    # Cuando seleccionas XMonad en GDM, este xrandr se aplica
  ...
  # ===========================================================================
  # KEYD: Remapeador de teclas Apple SPI Keyboard
  # ===========================================================================
  # Permite usar Fn + fila numerica como F-keys (workaround Touch Bar)
  # Funciona tanto en X11 como Wayland (a nivel kernel)
